...
final class GeoJsonSRIDCoordinatesParserTest extends TestCase
{
     ...
     */
    #[DataProvider('provideBuildLegacyCRSCases')]
     ...
     */
    public static function provideBuildLegacyCRSCases(): iterable
    {
        yield [null, 0000];
    ...
    #[DataProvider('provideGuessSRIDfromContentsCases')]
     ...
     */
    public static function provideGuessSRIDfromContentsCases(): iterable
    {
     ...
     */
    #[DataProvider('provideIdentifySRIDThrowsCases')]
     ...
     */
    public static function provideIdentifySRIDThrowsCases(): iterable
    {
