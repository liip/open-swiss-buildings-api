...
use App\Domain\FederalData\Repository\BuildingRepository;
...
class Building
{
     ...
     * Stato dell’edificio.
     */
    #[ORM\Column(name: 'GSTAT', length: 4, enumType: BuildingStatusEnum::class)]
    public BuildingStatusEnum $GSTAT;
