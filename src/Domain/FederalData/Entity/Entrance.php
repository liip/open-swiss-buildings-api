...
namespace App\Domain\FederalData\Entity;

use App\Domain\FederalData\Model\EntranceLanguageEnum;
use App\Domain\FederalData\Repository\EntranceRepository;
...
class Entrance
{
     ...
     */
    #[ORM\Id]
    #[ORM\Column(name: 'STRSP', length: 4, enumType: EntranceLanguageEnum::class)]
    public EntranceLanguageEnum $STRSP;
