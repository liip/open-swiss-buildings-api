...
final readonly class DoctrineMunicipalitiesIdsResolver extends AbstractDatabaseResolver
{
    ...
    protected function buildResultInsertSQL(TasksResultsConditions $conditions): string
    {
        ...
        $conditions->addBuildingConditions('t.matching_municipality_code = b.municipality_code');
        ...
        return "INSERT INTO {$resultTable} (id, job_id, confidence, match_type, country_code, building_id, building_entrance_id, additional_data) " .
            "SELECT gen_random_uuid(), t.job_id, t.confidence, t.match_type, b.country_code, b.building_id, b.id, t.additional_data FROM {$taskTable} t " .
